...
router.get('/getToken/', (req, res) =>{
    ...
    if (req.query.twitchCode) {
        ...
        const curlPromptToGetToken = `curl -X POST client_id=${process.env.CLENT_ID}&client_secret=${process.env.CLIENT_SECRET}&code=${req.session.twitchCode}&grant_type=authorization_code&redirect_uri='${process.env.GET_TOKEN_REDIRECT}'`
